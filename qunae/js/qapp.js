(function(){
	...
	/*=======================================================================
	 ...
	 qapp.js 0.2.5 build at 2015.05.17
	 ======================================================================*/
	...
	function _isPlainObject(source) {
	    if (!getType(source, 'Object') || source.nodeType || getType(
	            source, 'Window')) {
	        return FALSE;
	    }
	    try {
	        if (source.constructor && !__object__.hasOwnProperty.call(
	                source.constructor.prototype, 'isPrototypeOf')) {
	            return FALSE;
	        }
	    } catch (e) {
	        return FALSE;
	...
	function _isEmptyObject(source) {
	    if (getType(source, 'Object') && !keys(source).length) {
	        return TRUE;
	    }
	    return FALSE;
	}
	    ...
	    _extend(View.prototype, CustEvent, {
	        ...
	        show: function (container, startCss, endCss, duration) {
	            ...
	            if (me.isShow) {
	                ...
	                me.renderTo(container || Config.appRoot);
	            }
	            return me;
	        },
	        hide: function () {
	...
	define('decorator', function () {
	    ...
	    function Decorator(type, options) {
	        ...
	        me.name = '';
	        me.viewName = '';
	        me.type = type || Config.defaultAnimate;
	        me.options = options || {};
	        me.viewOpt = {};
	        me.showArgs = [];
	        me.container = NULL;
